...
/// 设备身份管理（双端 Keychain 持久化）
public final class DeviceIdentity: @unchecked Sendable {
    nonisolated(unsafe) public static let shared = DeviceIdentity()
    ...
    public lazy var signingKey: Curve25519.Signing.PrivateKey = {
    ...
    /// 验证签名
    public static func verify(signature: Data, for data: Data, publicKeyBase64: String) -> Bool {
